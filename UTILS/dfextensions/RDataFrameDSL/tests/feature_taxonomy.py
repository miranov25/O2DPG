...
FEATURE_TAXONOMY = {
    ...
    "broadcast_rvec_scalar": {
        "name": "RVec × scalar column broadcast (Phase 13.6.G)",
        "description": "Element-wise operations between RVec/RVec<RVec> and scalar columns (e.g., track_pt * event_weight, cluster_Q * event_weight)",
        "tests": [
            "tests/test_invariance_broadcast.py::TestInvarianceBroadcast::test_INV_BROADCAST_1_rvec_times_scalar",
            "tests/test_invariance_broadcast.py::TestInvarianceBroadcast::test_INV_BROADCAST_2_scalar_times_rvec",
            "tests/test_invariance_broadcast.py::TestInvarianceBroadcast::test_INV_BROADCAST_3_rvec_plus_scalar",
            "tests/test_invariance_broadcast.py::TestInvarianceBroadcast::test_INV_BROADCAST_4_rvec_div_scalar",
            "tests/test_invariance_broadcast.py::TestInvarianceBroadcast::test_INV_BROADCAST_5_int_times_rvec",
            "tests/test_invariance_broadcast.py::TestInvarianceBroadcast2D::test_INV_BROADCAST_2D_1_rvec2d_times_scalar",
            "tests/test_invariance_broadcast.py::TestInvarianceBroadcast2D::test_INV_BROADCAST_2D_2_scalar_times_rvec2d",
            "tests/test_invariance_broadcast.py::TestInvarianceBroadcast2D::test_INV_BROADCAST_2D_3_rvec2d_plus_scalar",
            "tests/test_invariance_broadcast.py::TestInvarianceBroadcast2D::test_INV_BROADCAST_2D_4_rvec2d_div_scalar",
            "tests/test_invariance_broadcast.py::TestInvarianceBroadcast2D::test_INV_BROADCAST_2D_5_int_times_rvec2d",
        ],
        "proof": None,
        "phase": "13.6.G",
    },
