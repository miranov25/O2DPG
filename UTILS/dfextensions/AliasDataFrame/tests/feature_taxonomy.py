...
FEATURES = [
    ...
    {"id": "TESTING.phase13_77_reference_governance",
     "name": "PHASE_13_77 A6 named-reference governance foundation",
     "description": "Activates the Stage-A reference_policy contract, reuses the PHASE_13_79 contract-file structure, derives explicit input/sample reference identity from existing A5 provenance, and refuses mismatched or incomplete named-reference identity instead of comparing unlike runs.",
     "category": "TESTING",
