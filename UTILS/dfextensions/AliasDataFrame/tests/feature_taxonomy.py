...
FEATURES = [
    ...
    {"id": "TESTING.phase13_77_stage_a_closure",
     "name": "PHASE_13_77 A6.3 Stage-A orchestration and closure evidence",
     "description": "Validates the single Stage-A CLI/PDF orchestration, complete gallery disposition, numerical-oracle closure reconciliation, and fail-closed comparison hardening before final acceptance.",
     "category": "TESTING",
     "test_patterns": [
