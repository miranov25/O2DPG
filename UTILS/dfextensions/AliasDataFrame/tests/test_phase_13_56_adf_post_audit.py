...
class TestG4Taxonomy:
    ...
    def test_TG4_dispatch_features_registered(self):
        ...
        assert len(FEATURES) == 57  # 56 + SUBFRAME.asymmetric_join_keys (PHASE_13_65); 56 = 55 + WRITE.column_assignment (PHASE_13_62 Stage 2a / Fix A); 55 = 54 + LAZY.expression_autoload (BUG_20260624_lazy_bridge); 54 = 53 + DISPATCH.dict_dispatch (13.61.ADF)
